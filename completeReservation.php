 ...
 <div class="container">
      ...
      <div class="main">
         <br>
          <div class="action">
              <h5>Issue Tickets</h5>
              <p>Please confirm the reservation information shown below <br>
                before completing payment.</p>
            
           <div class="due">
               <h4>Total Payment Due: BDT <script> var a=localStorage.getItem('fare'); 
                        ...
                        document.write(q*b);</script></h4>
           </div>
              
          <button class="back" onclick="window.location.href='reservation.php' "></a>Go Back</button>
          <button class="paybtn" onclick="window.location.href='payment.php'">Pay By Credit/Debit/Mobile Banking Account</button>
