...
<form action="clientSecurity2.php" method="post" >
    <div id="dlgbox">
            <div id="dlg-header">Something Wrong !</div>
        <div id="dlg-body"> <p>Please enter valid information </p>
            <p>Enter Licence No : <input type="text" name="lno" required></p>
            <p>Enter Password : <input type="text" name="pass" class="ml-2" required></p>
        </div>
        <div id="dlg-footer">
            <button>OK</button>
        </div>
