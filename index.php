...
<div class="container">
  <div class="row">
   <!-------------LEFT PART------------>
    ...
    <form method="post" id="content" class="flight" action="checkAccount.php">
      
      <div class="login">
          <h5>"You must have an account to <span class="font-weight-bold text-primary">search</span> our FLIGHTS!  <a href="pass_info.php" class="mcity">Signup Here <i class="fas fa-sign-in-alt"></i></a> </h5>
      </div>
      <hr>
       <h4 class="ml-3">Book My Flight</h4> <hr>
        
        <span class="search-type ml-3">
            <input type="radio" id="TT_RT" name="TT" onclick="hide(1);" value="Round Trip" checked=""> 
            <label onclick=";" for="TT_RT" class="TT_RT">Round Trip</label>
            <input type="radio" id="TT_OW" name="TT" onclick="hide(0)" value="One Way" class="ml-4"> 
       ...
       <br>
        ...
        <span class="dates">
            ...
            <input type="date" class="empty" name="RO" id="rd" >
        ...
        <span class="fieldset options">
            ...
            <select name="CC" class="empty" required><option value="">Any Cabin</option><option value="BC">Business Class</option><option value="EC">Economy Class</option></select> <br>
 ...
 <!------  login part-----
    <form method="post" class="form-2">
       <div class="login mt-1">
            <a href="login.php"><img src="Images" alt=""></a>
        </div>
    </form>
        ----------->
        <div class="join mt-1">
       ...
       <!------Flight Deals---->
        <div class="col-md-6">
           <div class="Table">
            ...
            <!--------USERPANEL-------->
            <div class="userHelp">
             <a href="clientSecurity.php"><img src="Images/user.jpeg" alt=""></a>   
