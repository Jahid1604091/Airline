...
<!---------------RETURNING TICKET--------->     
    <div class="row">
            ...
            <div class="col-md-4 main">
                <h5>Serach for Flights</h5>
                From : <span class="from"><?php echo $from=$_SESSION['$to'];?></span> <br>
                
                To : <span class="to"><?php echo $to=$_SESSION['$from'];?></span>
                ...
                <div class="col-md-8 main">
                 <div class="row">
                    <div class="col-md-3 mx-4">
                         ...
                         Returning On : <span class="text"><?php echo $_SESSION['$ro'];?></span>
                     </div>
                   ...
                   <?php
                    echo "<br>";
               $sql2 = "SELECT * FROM flight_section where DC='$to' and AC='$from' ";
         
        $result2=$conn->query($sql2);
                    
        if ($result2->num_rows > 0) {
        echo "<table id='table2'><tr><th>Flight(s)</th><th>Take Off</th><th>Route</th><th>Landing</th><th>Fare</th></tr>";
        // output data of each row
        while($row2 = $result2->fetch_assoc()) {
            echo "<tr>
            
            <td style='cursor: pointer;'> ".$row2["flight_no"]."</td>
            <td style='cursor: pointer;'>".$row2["takeOff"]."</td>
            <td style='cursor: pointer;'>".$row2["route"]."</td>
            <td style='cursor: pointer;'>".$row2["landing"]."</td>
            <td style='cursor: pointer;'>".$row2["fare"]."</td>
